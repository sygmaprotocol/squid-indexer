module.exports = class Data1733213697547 {
    name = 'Data1733213697547'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "fee" ("id" character varying NOT NULL, "amount" text NOT NULL, "resource_id" uuid, "deposit_id" character varying, "domain_id" character varying, CONSTRAINT "PK_ee7e51cc563615bc60c2b234635" PRIMARY KEY ("id"))`)
