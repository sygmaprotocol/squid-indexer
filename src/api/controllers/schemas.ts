...
export const transfersBySourceDomainToDestinationDomainSchema = {
  summary:
    "Get all transfers from a specific source domain to a specific destination domain",
  querystring: {
    type: "object",
    properties: {
      ...paginationSchema,
...
export const transfersByResourceBetweenDomainsSchema = {
  summary:
    "Get all transfers for a resource from a specific source domain to a specific destination domain",
  querystring: {
    type: "object",
    properties: {
      ...paginationSchema,
