...
export async function processExecutions(ctx: Context, executionsData: DecodedProposalExecutionLog[]): Promise<void> {

  for (let e of executionsData) {
...
export async function processFailedExecutions(ctx: Context, failedExecutionsData: DecodedFailedHandlerExecution[]): Promise<void> {

  for (let e of failedExecutionsData){
