...
export type FeeHandlerType = FeeHandlerType_BasicFeeHandler | FeeHandlerType_DynamicFeeHandler
...
export type TransferType = TransferType_FungibleTransfer | TransferType_GenericTransfer | TransferType_NonFungibleTransfer
