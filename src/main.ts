...
import { getSharedConfig, Domain as DomainConfig, SharedConfig, getSsmDomainConfig } from './config'
...
let substrateRpcUrlConfig: Map<number, ApiPromise>
async function initProcess(): Promise<void> {
    ...
    substrateRpcUrlConfig= await getSsmDomainConfig(process.env.SUPPORTED_SUBSTRATE_RPCS!)
}
