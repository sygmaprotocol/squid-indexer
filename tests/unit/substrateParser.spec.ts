...
import { Network, ResourceType, SubstrateResource } from "@buildwithsygma/core";
import { Domain } from "../../src/indexer/config";
import { events, v1260 } from "../../src/indexer/substrateIndexer/types";
...
import { V3AssetId, V3AssetId_Concrete } from "../../src/indexer/substrateIndexer/types/v1260";
...
describe("Substrate parser", () => {
    ...
    describe("parseDeposit", () => {
        it("should parse a deposit correctly", () => {
          ...
          sinon.stub(events.sygmaBridge.deposit.v1250, "decode").returns(decodedEvent);
    ...
    describe("parseProposalExecution", () => {
        it("should parse a proposal execution correctly", async() => {
          ...
          sinon.stub(events.sygmaBridge.proposalExecution.v1250, "decode").returns(decodedEvent);
    ...
    describe("parseFailedHandlerExecution", () => {
        it("should parse a failed handler execution correctly", async() => {
          ...
          sinon.stub(events.sygmaBridge.failedHandlerExecution.v1250, "decode").returns(decodedEvent);
    ...
    describe("parseFee", () => {
        it("should parse fee correctly", () => {
          ...
          sinon.stub(events.sygmaBridge.feeCollected.v1260, "decode").returns(decodedEvent);
          ...
          expect(result).to.deep.include({
            amount: "10",
            decimals: 12,
            tokenAddress: JSON.stringify({__kind: "Concrete",value: { parents: 1, interior: { __kind: 'X3', value: {} } }}),
            tokenSymbol: "PHA",
